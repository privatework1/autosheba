  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="createBrandForm" role="form" action="{{ route('vendor-site-brands.store') }}" method="POST" enctype="multipart/form-data">
          <fieldset class="scheduler-border">
            ...
            <button type="submit" class="pl-3 pr-3">Save</button>  <a href="{{ route('vendor-site-brands.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
