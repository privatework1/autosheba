        ...
        <div class="container" id="main_warp">
            <div class="row">
                <div class="col-lg-12 myimage">
                    <img src="{{asset('uploads/b2bcompany/'.$b2bpurchase->po_company_logo)}}" alt="" style="width:20px;height:20px;">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <address>
                                ...
                                <p><b>Company Name</b>: {{$b2bpurchase->po_company_name}}</p><br/>
                                <p><b>Company Email</b>: {{$b2bpurchase->po_company_email}}</p><br/>
                                <p><b>Company Mobile</b>: {{$b2bpurchase->po_company_mobile}}</p><br/>
                        ...
                        <div class="col-lg-6 text-right" style="">
                            <address>
                                ...
                                <p><b>Company Address</b>: {{$b2bpurchase->po_company_address}}</p><br/>
                                <p><b>Company Model</b>: {{$b2bpurchase->po_company_code}}</p><br/>
