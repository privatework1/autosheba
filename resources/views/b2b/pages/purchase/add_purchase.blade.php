...
@section('content')
    ...
    <div class="container-fluid">
        <div class="col-md-12 mt-3">
            ...
            <div class="poForm">
                <form action="{{url('/b2b-site-po')}}" method="post" class="" enctype="multipart/form-data">
                   {{csrf_field()}}
                    <div class="info">
                        <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="row p-5">
                                        <div class="col-md-6 poImage">
                                            <div class="form-group">
                                                ...
                                                &nbsp;<input type="file" name="po_company_logo" class="">
                                            </div>

                                           <div class="form-group">
                                               <label>Company Name</label>
                                               &nbsp;<input type="text" name="po_company_name" class="">
                                           </div>
                                            <div class="form-group">
                                                <label>Company Email</label>
                                                &nbsp;&nbsp;<input type="text" name="po_company_email">
                                            </div>
                                            <div class="form-group">
                                                <label>Company Mobile</label>
                                                <input type="text" name="po_company_mobile">
                                            </div>
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <div class="form-group">
                                                ...
                                                &nbsp;<textarea  name="po_company_address" class=""></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Model No:</label>
                                                &nbsp;<input type="text" name="po_company_code" class="">
                                            </div>
                                            <div class="form-group">
                                                <label>PO Date</label>
                                                &nbsp;&nbsp;<input type="text" name="po_date" id="datepicker" class="date-picker">
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="text" name="total_amount" class="total_amount" value="">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="submit" name="btn" value="Generate PO" class="btn btn-primary" style="float:right;">
