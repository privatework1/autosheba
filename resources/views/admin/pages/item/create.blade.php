  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-8">
        ...
        <form id="createItemForm" role="form" action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
          <fieldset class="scheduler-border">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="item_category">Brand <span class="text-danger">*</span></label>
                <select class="form-control" id="item_category" name="item_brand" required>
                ...
                @if ($errors->has('item_brand'))
                  <small class="text-danger font-weight-bold errortext">{{ $errors->first('item_brand') }}</small>
                @endif
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="tax_rate" name="tax_rate" placeholder="Enter Tax Rate" autocomplete="off">
              ...
              <div class="form-group mt-2">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input checkboxSingle checkBoxYes" type="checkbox" id="" name="warrenty" value="yes"/>
              ...
              <div class="checkBoxEnableDiv">
                <div class="form-group mt-2">
                  ...
                  <div class="controls">
                      <input type="text" class="form-control" id="warrenty_type" name="warrenty_type" placeholder="Warrenty Type"/>
                  </div>
                ...
                <div class="form-group mt-2">
                  ...
                  <div class="controls">
                      <input type="date" class="form-control" id="warrentyEndDate" name="warrentyEndDate" placeholder="End Date" />
                  </div>
                ...
                <div class="form-group mt-2">
                  ...
                  <div class="controls">
                      <textarea class="form-control" id="warrentyCondition" name="warrentyCondition" rows="3" placeholder="Warrenty Condition"></textarea>
                  </div>
              ...
              <div class="form-group">
                <label for="item_part_of">Features<span class="text-danger">*</span></label>

                <textarea class="form-control" name="item_part_of" id="editor2" rows="10" cols="80"></textarea>

              </div>

              <div class="form-group">
                <label for="item_model_no">Model No.</label>
                <input type="text" class="form-control" id="item_model_no" name="item_model_no" value="<?php echo str_random(5); ?>" placeholder="Enter Model No" autocomplete="off">
              ...
              <div class="form-group">
                <label for="item_model_no">Size <span class="text-danger">*</span></label>
                <input type="checkbox" class="" id="" name="item_size[]" value="large" placeholder="Enter Model No" autocomplete="off">Large
                <input type="checkbox" class="" id="" name="item_size[]" value="medium" placeholder="Enter Model No" autocomplete="off">Medium
                <input type="checkbox" class="" id="" name="item_size[]" value="small" placeholder="Enter Model No" autocomplete="off">Small
            ...
            <button type="submit" class="pl-3 pr-3">Save</button>  <a href="{{ route('item.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
