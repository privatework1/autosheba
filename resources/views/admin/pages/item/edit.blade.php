  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="editItemForm" role="form" action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
          <fieldset class="scheduler-border">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="item_category">Brands <span class="text-danger">*</span></label>
                <select class="form-control" id="item_category" name="item_brand" required>
                  <option value="" disabled selected hidden>Select Brand</option>
                  @if(count($brands)>0)
                    @foreach($brands as $brand)
                      <option value="{{ $brand->id }}" <?php if($brand->id==$item->item_brand){echo 'selected';}?>>{{ $brand->brand_name  }}</option>
                    @endforeach
                  @endif
                </select>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="tax_rate" name="tax_rate" placeholder="Enter Tax Rate" autocomplete="off" value="{{ $item->tax_rate }}">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="item_part_of" id="editor2" rows="10" cols="80">{!! base64_decode($item->item_feature) !!}</textarea>
              ...
              <div class="form-group">
                ...
                <input type="checkbox" class="" id="" name="item_size[]" <?php if (in_array('large', $size_array)) echo "checked"; else echo "";  ?> value="large" placeholder="Enter Model No" autocomplete="off">Large
                <input type="checkbox" class="" id="" name="item_size[]"  <?php if (in_array('medium', $size_array)) echo "checked"; else echo "";  ?> value="medium" placeholder="Enter Model No" autocomplete="off">Medium
                <input type="checkbox" class="" id="" name="item_size[]" <?php if (in_array('small', $size_array)) echo "checked"; else echo "";  ?> value="small" placeholder="Enter Model No" autocomplete="off">Small
            ...
            <button type="submit" class="pl-3 pr-3">Update</button>  <a href="{{ route('item.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
