  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="editVendorForm" role="form" action="{{ route('vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
          <fieldset class="scheduler-border">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="vendor_title">Password</label>
                <input type="password" class="form-control" id="vendor_title" name="password" placeholder="Enter Vendor Password" autocomplete="off">
            ...
            <button type="submit" class="pl-3 pr-3">Update</button>  <a href="{{ route('vendors.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
