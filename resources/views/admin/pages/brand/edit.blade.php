  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="editBrandForm" role="form" action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
          <fieldset class="scheduler-border">
            ...
            <button type="submit" class="pl-3 pr-3">Update</button>  <a href="{{ route('brands.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
