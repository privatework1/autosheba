  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        @endif
        <form id="editCategoryForm" role="form" action="{{ route('categories.update', $category->id) }}" method="POST">
            <fieldset class="scheduler-border">
              ...
              <button type="submit" class="pl-3 pr-3">Update</button> <a href="{{ route('categories.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
            </fieldset>
          </form>
      </div>
    </div>
