  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="createCategoryForm" role="form" action="{{ route('categories.store') }}" method="POST">
          <fieldset class="scheduler-border">
            ...
            <button type="submit" class="pl-3 pr-3">Save</button>  <a href="{{ route('categories.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
