  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="createsubCategoryForm" role="form" action="{{ route('subcategories.store') }}" method="POST">
          ...
          <button type="submit" class="pl-3 pr-3">Save</button>  <a href="{{ route('subcategories.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
