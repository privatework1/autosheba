  ...
  <div class="container-fluid pl-4">
    <div class="row">
      <div class="col-md-6">
        ...
        <form id="editsubCategoryForm" role="form" action="{{ route('subcategories.update', $subcategory->id) }}" method="POST">
          ...
          <button type="submit" class="pl-3 pr-3">Update</button>  <a href="{{ route('subcategories.index') }}"><button type="button" class="pl-3 pr-3">View</button></a>
          </fieldset>
        </form>
      </div>
    </div>
