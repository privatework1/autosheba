...
class SubcategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pages.subCategory.create')->with('allCategory', $allCategory);
    }
    ...
    public function show($id)
    {
      ...
      return view('admin.pages.subCategory.view')->with('subcategory', $subcategory)->with('category', $category);
    }
    ...
    public function edit($id)
    {
      $allCategory = Category::orderBy('created_at', 'DESC')->get();
      $subcategory = SubCategory::find($id);
      return view('admin.pages.subCategory.edit')->with('subcategory', $subcategory)->with('allCategory', $allCategory);
    }
