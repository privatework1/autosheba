...
class ItemController extends Controller
{
    ...
    public function index()
    {
      ...
      $vendors = Vendor::all();
      return view('admin.pages.item.index')->with('items', $items)->with('categories', $categories)->with('vendors', $vendors);
    }
    ...
    public function create()
    {
      ...
      return view('admin.pages.item.create')->with('allCategory', $allCategory)->with('allVendor', $allVendor)->with('brands',$brands);
    }
    ...
    public function store(Request $request)
    {
      ...
      $size=implode(",",$request->item_size);
      ...
      if ($validator->fails()) {
        ...
        if($request->files->get('itemImages') == "") { 
          ...
          $item->item_size=$size;
          $item->item_feature=base64_encode($request->item_part_of);
    ...
    public function show($id)
    {
      ...
      return view('admin.pages.item.view')->with('item', $item);
    }
    ...
    public function edit($id)
    {
      ...
      $allCategory = Category::orderBy('created_at', 'DESC')->get();
      $allVendor = Vendor::orderBy('created_at', 'DESC')->get();
      return view('admin.pages.item.edit')->with('item', $item)->with('allCategory', $allCategory)->with('allVendor',$allVendor)->with('brands',$brands);
    }
